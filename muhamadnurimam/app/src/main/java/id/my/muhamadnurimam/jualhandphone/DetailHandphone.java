package id.my.muhamadnurimam.jualhandphone;
...
import id.my.muhamadnurimam.jualhandphone.model.Handphone;
import id.my.muhamadnurimam.jualhandphone.server.AsyncInvokeURLTask;
...
public class DetailHandphone extends AppCompatActivity {
    ...
    private void initView(){
        EditText textNama = (EditText) findViewById(R.id.add_new_nama);
        EditText textHarga = (EditText) findViewById(R.id.add_new_harga);
